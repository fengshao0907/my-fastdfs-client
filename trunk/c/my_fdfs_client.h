...
**/
#define my_fdfs_upload_by_filename(local_filename, file_ext_name, \
		group_name, my_file_id) \
	my_fdfs_upload_by_filename_ex(my_file_id, \
		STORAGE_PROTO_CMD_UPLOAD_FILE, \
		local_filename, file_ext_name, group_name)

#define my_fdfs_upload_appender_by_filename(my_file_id, local_filename, \
		file_ext_name, group_name) \
	my_fdfs_upload_by_filename_ex(my_file_id, \
...
* return: 0 success, !=0 fail, return the error code
**/
#define my_fdfs_upload_by_filebuff(my_file_id, file_buff, file_size, \
		file_ext_name, group_name) \
	my_fdfs_do_upload_file(my_file_id, STORAGE_PROTO_CMD_UPLOAD_FILE, \
		FDFS_UPLOAD_BY_BUFF, file_buff, NULL, \
		file_size, file_ext_name, group_name)

#define my_fdfs_upload_appender_by_filebuff(my_file_id, file_buff, file_size, \
		file_ext_name, group_name) \
	my_fdfs_do_upload_file(my_file_id, STORAGE_PROTO_CMD_UPLOAD_APPENDER_FILE, \
		FDFS_UPLOAD_BY_BUFF, file_buff, NULL, \
		file_size, file_ext_name, group_name)

int my_fdfs_do_upload_file(const char *my_file_id, const char cmd, \
...
* return: 0 success, !=0 fail, return the error code
**/
#define my_fdfs_upload_by_callback(my_file_id, callback, arg, \
		file_size, file_ext_name, group_name) \
	my_fdfs_upload_by_callback_ex(my_file_id, STORAGE_PROTO_CMD_UPLOAD_FILE, \
		callback, arg, file_size, file_ext_name, group_name)

#define my_fdfs_upload_appender_by_callback(my_file_id, callback, arg, \
		file_size, file_ext_name, group_name) \
	my_fdfs_upload_by_callback_ex(my_file_id, \
		STORAGE_PROTO_CMD_UPLOAD_APPENDER_FILE, \
		callback, arg, file_size, file_ext_name, group_name)

int my_fdfs_upload_by_callback_ex(const char *my_file_id, const char cmd, \
...
* return: 0 success, !=0 fail, return the error code
**/
int my_fdfs_delete_file(const char *my_file_id);
...
* return: 0 success, !=0 fail, return the error code
**/
#define my_fdfs_download_file(my_file_id, file_buff, file_size)  \
	my_fdfs_do_download_file_ex(FDFS_DOWNLOAD_TO_BUFF, my_file_id, 0, 0, \
			file_buff, NULL, file_size)

#define my_fdfs_download_file_to_buff(my_file_id, file_buff, file_size)  \
	my_fdfs_do_download_file_ex(FDFS_DOWNLOAD_TO_BUFF, my_file_id, 0, 0, \
			file_buff, NULL, file_size)

#define my_fdfs_do_download_file(download_type, my_file_id, file_buff, file_size) \
	my_fdfs_do_download_file_ex(download_type, my_file_id, \
...
* return: 0 success, !=0 fail, return the error code
**/
int my_fdfs_do_download_file_ex(const int download_type, const char *my_file_id, \
...
* return: 0 success, !=0 fail, return the error code
**/
int my_fdfs_download_file_to_file(const char *my_file_id, \
...
* return: 0 success, !=0 fail, return the error code
**/
int my_fdfs_download_file_ex(const char *my_file_id, \
		const int64_t file_offset, const int64_t download_bytes, \
...
* return: 0 success, !=0 fail, return the error code
**/
int my_fdfs_append_by_filename(const char *my_appender_file_id, \
...
* return: 0 success, !=0 fail, return the error code
**/
int my_fdfs_append_by_filebuff(const char *my_appender_file_id, \
...
* return: 0 success, !=0 fail, return the error code
**/
int my_fdfs_append_by_callback(const char *my_appender_file_id, \
...
* return: 0 success, !=0 fail, return the error code
**/
int my_fdfs_modify_by_filename(const char *my_appender_file_id, \
...
* return: 0 success, !=0 fail, return the error code
**/
int my_fdfs_modify_by_callback(const char *my_appender_file_id, \
		UploadCallback callback, void *arg, \
...
* return: 0 success, !=0 fail, return the error code
**/
int my_fdfs_modify_by_filebuff(const char *my_appender_file_id, \
		const char *file_buff, const int64_t file_offset, \
...
* return: 0 success, !=0 fail, return the error code
**/
int my_fdfs_truncate_file(const char *my_appender_file_id, \
		const int64_t truncated_file_size);


#define my_fdfs_query_file_info(my_file_id, pFileInfo) \
	my_fdfs_query_file_info_ex(my_file_id, pFileInfo, false)
...
* return: 0 success, !=0 fail, return the error code
**/
int my_fdfs_query_file_info_ex(const char *my_file_id, \
		FDFSFileInfo *pFileInfo, const bool bSilence);

#define my_fdfs_get_file_info(my_file_id, pFileInfo) \
	my_fdfs_get_file_info_ex(my_file_id, true, pFileInfo)
...
* return: 0 success, !=0 fail, return the error code
**/
int my_fdfs_get_file_info_ex(const char *my_file_id, const bool get_from_server, \
...
**/
int my_fdfs_file_exist(const char *my_file_id);
